...
import { POLICY_GET_KIWISAVER_LIST_QUERY, POLICY_UPDATE_KIWISAVER_MUTATION, POLICY_CREATE_KIWISAVER_MUTATION, POLICY_DELETE_KIWISAVER_MUTATION } from "../../../utils"
...
export const PolicyAllKiwisaver = (props: TProps) => {
  const fetchQuery = useQuery(POLICY_GET_KIWISAVER_LIST_QUERY, {})
