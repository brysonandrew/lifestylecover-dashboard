  ...
  if (graphQLErrors) {
    graphQLErrors.map(({ message, locations, path }) => {
      ...
      if (message.includes("not authenticated")) {
        snackbarStore.dispatch.snackbar.handleOpen({message: 'Please log in', severity: 'info', redirect: LOGIN_ROUTE});
      }
      // else {
    ...
    if (
      ...
      snackbarStore.dispatch.snackbar.handleOpen({message: 'Forbidden', severity: 'info', redirect: LOGIN_ROUTE});
    }
