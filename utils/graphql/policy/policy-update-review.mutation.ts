...
export const POLICY_UPDATE_REVIEW_RISK_MUTATION = gql`
  mutation POLICY_UPDATE_REVIEW_RISK($id: ID!, $reviewMeta: String!) {
    updatePolicyRisk(
      input: {
...
export const POLICY_UPDATE_REVIEW_ASSET_MUTATION = gql`
  mutation POLICY_UPDATE_REVIEW_ASSET($id: ID!, $reviewMeta: String!) {
    updatePolicyAsset(
      input: {
...
export const POLICY_UPDATE_REVIEW_KIWISAVER_MUTATION = gql`
  mutation POLICY_UPDATE_REVIEW_KIWISAVER($id: ID!, $reviewMeta: String!) {
...
export const POLICY_UPDATE_REVIEW_PET_MUTATION = gql`
  mutation POLICY_UPDATE_REVIEW_PET($id: ID!, $reviewMeta: String!) {
    updatePolicyPet(
      input: {
